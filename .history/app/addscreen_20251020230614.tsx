...
export default function AddScreen() {
  ...
  const editReviewer: Reviewer | null = params.editReviewer
    ? JSON.parse(params.editReviewer as string)
    : null;
  const { user } = useAuth();
  ...
  // Add a new question
  const addQuestion = () => {
    if (!question || !answer) return Alert.alert('Please fill in both question and answer');
