...
export default function IndexScreen() {
  ...
  const handleReview = (reviewer: Reviewer) => {
    // push into the review tab and pass questions as a param
    router.push({
      pathname: '/(tabs)/reviewsection' as any,
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Button title="Create New Reviewer" onPress={() => router.push('/(tabs)/addscreen' as any)} />
    </View>
  );
}
