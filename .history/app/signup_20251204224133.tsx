...
export default function Signup() {
  ...
  try {
    ...
    // Navigate automatically to login (or home)
    router.replace("/login"); // or "/home" if you want to go straight to home
  } catch (err: any) {
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.passwordContainer}>
          ...
          <TextInput placeholder="Password" value={password} onChangeText={setPassword} style={styles.passwordInput} secureTextEntry={!showPassword} />
        ...
        <View style={styles.passwordContainer}>
          <Ionicons name="lock-closed-outline" size={20} color="#7A4D00" style={styles.icon} />
          <TextInput placeholder="Confirm Password" value={confirmPass} onChangeText={setConfirmPass} style={styles.passwordInput} secureTextEntry={!showConfirm} />
