...
import { collection, deleteDoc, doc, getDocs,doc } from 'firebase/firestore';
...
const styles = StyleSheet.create({
  ...
  logoutBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#D62828', padding: 8, borderRadius: 8 },
