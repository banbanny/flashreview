...
export default function IndexScreen({ navigation }: { navigation: HomeNavigationProp }) {
  ...
  const editReviewer = (r: Reviewer) => {
    navigation.navigate('AddScreen', { editReviewer: r });
  };
          ...
          <View style={styles.card}>
            ...
            <View style={styles.btnRow}>
              <TouchableOpacity
                ...
                onPress={() => router.push('ReviewScreen', { questions: item.questions })}
              >
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: 'bold', color: '#7A4D00', marginBottom: 10 },
